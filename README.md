...
- GET _http://localhost:3000_ - PostgreSQL Admin 4 - Usuário: root@postgresql.org - Senha: root
...
- A conexão do banco de dados nos serviços escritos em Golang, estão num contexto global (dentro do pacote models) pois não consegui repassa-lá utilizando _Closure_. Nas funções executadas pelo [_taskq_](https://github.com/vmihailenco/taskq), a conexão sofria um erro de _dereference_.
